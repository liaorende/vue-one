<template>
    <div class="wrap">
        <div class="scroll" :class="{'noscroll':show}">
            <div class="movie">
                <div :style="`background-image:url(${data.feeds_cover})`" class="header">
                    <div class="musicInfo">
                        <img class="singerImg" :src="data.cover" alt="">
                        <audio ref="song" src="https://m128.xiami.net/263/7263/2102736824/1795811213_1493002977979.mp3"></audio>
                        <img class="cdImg" :class="{'play':!isPlay,'pause':isPlay}" src="../assets/img/MusicFeedsPlaceHolder@2x.png" alt="">
